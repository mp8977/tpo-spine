...
class ContactPeopleControllerTest < ActionController::TestCase
  ...
  test "should create contact_person" do
    assert_difference('ContactPerson.count') do
      post :create, contact_person: { firstName: @contact_person.firstName, lastName: @contact_person.lastName, phone: @contact_person.phone, relationship: @contact_person.relationship }
    end
  ...
  test "should update contact_person" do
    patch :update, id: @contact_person, contact_person: { firstName: @contact_person.firstName, lastName: @contact_person.lastName, phone: @contact_person.phone, relationship: @contact_person.relationship }
    assert_redirected_to contact_person_path(assigns(:contact_person))
  end
