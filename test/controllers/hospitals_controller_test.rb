...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { hospitalName: @hospital.hospitalName, hospitalNumber: @hospital.hospitalNumber }
    end
  ...
  test "should update hospital" do
    patch :update, id: @hospital, hospital: { hospitalName: @hospital.hospitalName, hospitalNumber: @hospital.hospitalNumber }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
