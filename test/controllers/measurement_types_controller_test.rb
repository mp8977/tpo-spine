...
class MeasurementTypesControllerTest < ActionController::TestCase
  ...
  test "should create measurement_type" do
    assert_difference('MeasurementType.count') do
      post :create, measurement_type: { deleted: @measurement_type.deleted, max_value: @measurement_type.max_value, max_value: @measurement_type.max_value, min_value: @measurement_type.min_value, min_value: @measurement_type.min_value, name: @measurement_type.name }
    end
  ...
  test "should update measurement_type" do
    patch :update, id: @measurement_type, measurement_type: { deleted: @measurement_type.deleted, max_value: @measurement_type.max_value, max_value: @measurement_type.max_value, min_value: @measurement_type.min_value, min_value: @measurement_type.min_value, name: @measurement_type.name }
    assert_redirected_to measurement_type_path(assigns(:measurement_type))
  end
