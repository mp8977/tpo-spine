...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { inUse: @medicine.inUse, medicineNumber: @medicine.medicineNumber, name: @medicine.name }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { inUse: @medicine.inUse, medicineNumber: @medicine.medicineNumber, name: @medicine.name }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
