...
class NursesControllerTest < ActionController::TestCase
  ...
  test "should create nurse" do
    assert_difference('Nurse.count') do
      post :create, nurse: { email: @nurse.email, firstName: @nurse.firstName, lastName: @nurse.lastName, nurseNumber: @nurse.nurseNumber, password: @nurse.password, phone: @nurse.phone }
    end
  ...
  test "should update nurse" do
    patch :update, id: @nurse, nurse: { email: @nurse.email, firstName: @nurse.firstName, lastName: @nurse.lastName, nurseNumber: @nurse.nurseNumber, password: @nurse.password, phone: @nurse.phone }
    assert_redirected_to nurse_path(assigns(:nurse))
  end
